...
public class CommandTable {
	 ...
	 * @see KeyData
	 */
	public Action interpretationCommandFromKeyData(CharacterData character, Deque<KeyData> input) {
		Key nowKeyData;
		boolean pushA = false;
		boolean pushB = false;
		boolean pushC = false;
	 ...
	 * @see Key
	 */
	public Action interpretationCommandFromKey(CharacterData character, Deque<Key> input) {
		boolean pushA = false;
		boolean pushB = false;
		boolean pushC = false;

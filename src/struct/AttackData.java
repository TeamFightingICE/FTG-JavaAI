...
public class AttackData {
	...
	public AttackData(GrpcAttackData attackData) {
		...
		this.currentHitArea = new HitArea(attackData.getCurrentHitArea());
		this.currentFrame = attackData.getCurrentFrame();
		this.playerNumber = attackData.getPlayerNumber();
		...
		this.downProp = attackData.getDownProp();
		this.isProjectile = attackData.getIsProjectile();
	}
